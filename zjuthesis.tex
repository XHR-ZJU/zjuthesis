...
\documentclass[
    ...
    % Title
    Title           = 复杂场景下自动驾驶赛车的运动控制,
    TitleEng        = {{Motion Control of Autonomous Racing Cars in Complex Environments}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{复杂场景下自动驾驶}{赛车的运动控制}
\titleengtwolines{Motion Control of Autonomous}{Racing Cars in Complex Environments}

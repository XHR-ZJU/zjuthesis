...
% Author     : Zixuan Wang
% Email      : zxwang42 [at] gmail.comhttps://gist.github.com/cJamesSmith/d14300bcdd36416d913fa6bd3fb95ccc#file-settings-json
...
\documentclass[
    ...
    % Thesis Info
    ClassNumber     = TP273,          % 按中国图书分类法，学位办网上可查
    Security        = 公开,              % 注明密级与保密期限，仅限于论文课题来源于国防军工项目，如没有请填：无
    StudentName     = 徐浩然,
    StudentID       = 22332044,
    AdvisorName     = 任沁源,
    ...
    % Title
    Title           = 高速无人赛车的运动控制与导航方法研究,
    TitleEng        = {{Motion Control and Navigation of High-Speed Autonomous Racing Cars}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{高速无人赛车的}{运动控制与导航方法研究}
\titleengtwolines{Motion Control and Navigation of}{High-Speed Autonomous Racing Cars}
